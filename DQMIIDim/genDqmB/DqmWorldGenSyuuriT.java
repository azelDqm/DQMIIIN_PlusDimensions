...
import DQMII.DqmEventSyuuri;
import DQMII.DqmItemList;
import cpw.mods.fml.common.IWorldGenerator;

public class DqmWorldGenSyuuriT implements IWorldGenerator
{
	private int Hougaku = 0;
	private int yMain = 0;
    public DqmWorldGenSyuuriT(boolean b) {	}
    public DqmWorldGenSyuuriT() {}
    public DqmWorldGenSyuuriT(int face, int par2)
    {
    	this.Hougaku = face;
    	this.yMain = par2;
    }
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        }else
        {
	        ...
	        par3World.setBlock(xxx - (2 * byV), yyy + 1, zzz + (4 * byV), DqmItemList.Taimatu.blockID, tai2, 2);
	        par3World.setBlock(xxx + (4 * byV), yyy + 1, zzz + (3 * byV), DqmItemList.Bouguya.blockID, this.Hougaku, 2);
	        par3World.setBlock(xxx + (4 * byV), yyy + 1, zzz - (3 * byV), DqmItemList.Bouguya.blockID, this.Hougaku, 2);
        }
