...
public class DqmBlockLeaves extends DqmBlockLeavesBase implements IShearable
{
    ...
    public DqmBlockLeaves(int par1)
    {
...
*/
    ...
    {
        return BlockList.DqmBlockSapling.blockID;
    	//return this.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            if (par1World.rand.nextInt(j1) == 0)
            {
                ...
                //this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(k1, 1, l));
            }
    ...
    public Icon getIcon(int par1, int par2)
    {
    	...
    	//return this.iconArray[this.field_94394_cP][par2];
    	//System.out.println("ファイル名3:" + par1 + "/" + par2);
    	return this.iconArray[this.field_94394_cP][par2];
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < 2; ++i)
        {
            this.iconArray[i] = new Icon[9];

            for (int j = 0; j < 9; ++j)
            {
            	if(i == 0)
            	{
            		this.iconArray[i][j] = par1IconRegister.registerIcon("leavesN_" + j);
            	}else
            	{
            		this.iconArray[i][j] = par1IconRegister.registerIcon("leavesN_opaque_" + j);
            	}
