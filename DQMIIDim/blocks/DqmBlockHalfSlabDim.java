...
public class DqmBlockHalfSlabDim extends Block
{
    protected final boolean isDoubleSlab;
    private Icon[] iconArray;
    //private int setPos;

    public DqmBlockHalfSlabDim(int par1, boolean par2, Material par3Material)
    {
...
*/
    ...
    {
        return par0 == BlockList.DqmDimWoodHalf.blockID;
    }
