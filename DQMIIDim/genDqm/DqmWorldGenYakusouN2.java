...
public class DqmWorldGenYakusouN2 implements IWorldGenerator
{
    public DqmWorldGenYakusouN2(boolean b) {	}
    public DqmWorldGenYakusouN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.YakusouSeed.blockID, rand.nextInt(4), 2);
        }
    }
}
