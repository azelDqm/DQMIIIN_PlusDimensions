...
public class DqmWorldGenMamorinotaneN2 implements IWorldGenerator
{
    public DqmWorldGenMamorinotaneN2(boolean b) {	}
    public DqmWorldGenMamorinotaneN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.MamoriSeed.blockID, rand.nextInt(4), 2);
        }
    }
}
