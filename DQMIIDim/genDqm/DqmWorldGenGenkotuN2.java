...
public class DqmWorldGenGenkotuN2 implements IWorldGenerator
{
    public DqmWorldGenGenkotuN2(boolean b) {	}
    public DqmWorldGenGenkotuN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.DqmBlockGenkotu.blockID, rand.nextInt(4), 2);
        }
    }
}
