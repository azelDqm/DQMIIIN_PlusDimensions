...
public class DqmWorldGenTuboN2 implements IWorldGenerator
{
    public DqmWorldGenTuboN2(boolean b) {	}
    public DqmWorldGenTuboN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.Tubo.blockID, rand.nextInt(4), 2);
        }
    }
}
