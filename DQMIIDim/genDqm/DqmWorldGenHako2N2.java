...
public class DqmWorldGenHako2N2 implements IWorldGenerator
{
    public DqmWorldGenHako2N2(boolean b) {	}
    public DqmWorldGenHako2N2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        if (ran >= 96 && WorldGenFunctions.canGenerate(rand, par3World, x, y, z, 1))
        {
            par3World.setBlock(x, y, z, DqmItemList.DqmBlockHako2.blockID, rand.nextInt(4), 2);
        }
    }
}