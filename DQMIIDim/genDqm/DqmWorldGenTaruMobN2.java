...
public class DqmWorldGenTaruMobN2 implements IWorldGenerator
{
    public DqmWorldGenTaruMobN2(boolean b) {	}
    public DqmWorldGenTaruMobN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.TaruMob.blockID, rand.nextInt(4), 2);
        }
    }
}
