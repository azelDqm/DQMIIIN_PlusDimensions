...
public class DqmWorldGenDokukesisouN2 implements IWorldGenerator
{
    public DqmWorldGenDokukesisouN2(boolean b) {	}
    public DqmWorldGenDokukesisouN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        if (ran >= 70  && WorldGenFunctions.canGenerate(rand, par3World, x, y, z, 1))
        {
            par3World.setBlock(x, y, z, DqmItemList.DokukesisouSeed.blockID, rand.nextInt(4), 2);
        }
    }
}
