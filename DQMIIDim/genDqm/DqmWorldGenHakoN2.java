...
public class DqmWorldGenHakoN2 implements IWorldGenerator
{
    public DqmWorldGenHakoN2(boolean b) {	}
    public DqmWorldGenHakoN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.DqmBlockHako.blockID, rand.nextInt(4), 2);
        }
    }
}
