...
public class DqmWorldGenHako12N2 implements IWorldGenerator
{
    public DqmWorldGenHako12N2(boolean b) {	}
    public DqmWorldGenHako12N2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.DqmBlockHako12.blockID, rand.nextInt(4), 2);
        }
    }
}