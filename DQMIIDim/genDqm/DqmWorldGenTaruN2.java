...
public class DqmWorldGenTaruN2 implements IWorldGenerator
{
    public DqmWorldGenTaruN2(boolean b) {	}
    public DqmWorldGenTaruN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.Taru.blockID, rand.nextInt(4), 2);
        }
    }
}
