...
public class DqmWorldGenSikabaneMobN2 implements IWorldGenerator
{
    public DqmWorldGenSikabaneMobN2(boolean b) {	}
    public DqmWorldGenSikabaneMobN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.SikabaneMob.blockID, rand.nextInt(4), 2);
        }
