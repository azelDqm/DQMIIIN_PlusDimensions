...
public class DqmWorldGenTueN2 implements IWorldGenerator
{
    public DqmWorldGenTueN2(boolean b) {	}
    public DqmWorldGenTueN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        if (ran >= 980 && WorldGenFunctions.canGenerate(rand, par3World, x, y, z, 1))
        {
            par3World.setBlock(x, y, z, DqmItemList.Tue.blockID, rand.nextInt(4), 2);
        }
    }
}
