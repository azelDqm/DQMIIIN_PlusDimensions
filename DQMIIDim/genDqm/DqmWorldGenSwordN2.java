...
public class DqmWorldGenSwordN2 implements IWorldGenerator
{
    public DqmWorldGenSwordN2(boolean b) {	}
    public DqmWorldGenSwordN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y + 1, z, DqmItemList.Sword.blockID, rand.nextInt(4), 2);
