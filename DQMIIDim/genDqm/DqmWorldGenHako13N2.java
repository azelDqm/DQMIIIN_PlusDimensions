...
public class DqmWorldGenHako13N2 implements IWorldGenerator
{
    public DqmWorldGenHako13N2(boolean b) {	}
    public DqmWorldGenHako13N2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        if (ran >= 95 && WorldGenFunctions.canGenerate(rand, par3World, x, y, z, 1))
        {
            par3World.setBlock(x, y, z, DqmItemList.DqmBlockHako13.blockID, rand.nextInt(4), 2);
        }
    }
}