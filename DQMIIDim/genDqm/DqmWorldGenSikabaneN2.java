...
public class DqmWorldGenSikabaneN2 implements IWorldGenerator
{
    public DqmWorldGenSikabaneN2(boolean b) {	}
    public DqmWorldGenSikabaneN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.Sikabane.blockID, rand.nextInt(4), 2);
        }
    }
}
