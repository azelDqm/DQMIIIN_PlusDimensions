...
public class DqmWorldGenTikaranotaneN2 implements IWorldGenerator
{
    public DqmWorldGenTikaranotaneN2(boolean b) {	}
    public DqmWorldGenTikaranotaneN2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.TikaraSeed.blockID, rand.nextInt(4), 2);
        }
    }
}
