...
public class DqmWorldGenTubo2N2 implements IWorldGenerator
{
    public DqmWorldGenTubo2N2(boolean b) {	}
    public DqmWorldGenTubo2N2() {}
    ...
    public void generate(Random rand, int par1, int par2, World par3World, IChunkProvider par4IChunkProvider, IChunkProvider par5IChunkProvider)
    {
        ...
        {
            par3World.setBlock(x, y, z, DqmItemList.Akumanotubo.blockID, rand.nextInt(4), 2);
        }
    }
}
