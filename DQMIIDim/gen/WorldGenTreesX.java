...
public class WorldGenTreesX extends WorldGenTrees //WorldGenerator
{
    ...
    public WorldGenTreesX(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenTreesX(boolean par1, byte par2, byte par3)
    {
        this(par1, 4, 0, 0, false);
    	this.topBlockID = par2;
    	this.fillerBlockID = par3;
    }


    public WorldGenTreesX(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate2(World par1World, Random par2Random, int par3, int par4, int par5, int idx)
    {
    	//int idx = 8;
    	BiomeGenBase biome = par1World.getBiomeGenForCoords(par3, par5);
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
                    ...
                    for (j1 = par5 - b0; j1 <= par5 + b0 && flag; ++j1)
                    {
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            if (k1 != 0 &&
                                    ...
                                    (byte)k1 != (byte)this.topBlockID &&
                                    (byte)k1 != (byte)this.fillerBlockID &&
            ...
            else
            {
                ...
                boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockSapling)BlockList.DqmBlockSapling));
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        //this.setBlockAndMetadata(par1World, j2, j1, l2, BlockList.DqmBlockLeaves.blockID, this.metaLeaves);
                                    	this.setBlockAndMetadata(par1World, j2, j1, l2, BlockList.DqmBlockLeaves.blockID, idx);
                                    	//System.out.println("DEBUGLINE1:" + idx);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            //this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, BlockList.DqmBlockLog.blockID, this.metaWood);
                        	this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, BlockList.DqmBlockLog.blockID, idx);
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    if (block == null || block.canBeReplacedByLeaves(par1World, j2, j1, l2))
                                    {
                                        //this.setBlockAndMetadata(par1World, j2, j1, l2, BlockList.DqmBlockLeaves.blockID, this.metaLeaves);
                                    	this.setBlockAndMetadata(par1World, j2, j1, l2, BlockList.DqmBlockLeaves.blockID, idx);
                                    	//System.out.println("DEBUGLINE2:" + idx);
                                    }
                                }
                            }
                        }
