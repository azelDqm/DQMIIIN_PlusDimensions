...
public class WorldGenMinableX extends WorldGenerator
{
    ...
    public WorldGenMinableX(int par1, int par2)
    {
        this(par1, par2, BlockList.DqmDimStone.blockID);
    }

    public WorldGenMinableX(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableX(int id, int meta, int number, int target)
    {
