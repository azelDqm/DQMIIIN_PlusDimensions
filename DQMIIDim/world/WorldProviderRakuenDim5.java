...
public class WorldProviderRakuenDim5 extends WorldProvider
{

	public static final BiomeGenBase biomeRakuen = new BiomeRakuen(DqmNextDim.cfgDimBiomeID[DqmNextDim.idxSuraimu]);
    ...
    public void registerWorldChunkManager()
    {
    	...
    	this.dimensionId = DqmNextDim.cfgDimensionID[DqmNextDim.idxSuraimu];
    }

    @Override
    public String getDimensionName()
    {
        return "RakuenOfSuraimu";
    }
    ...
    {
        return new ChunkProviderRakuenDim(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), DqmNextDim.idxSuraimu);
