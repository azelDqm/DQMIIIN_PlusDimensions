...
public class WorldProviderRakuenDim4 extends WorldProvider
{

	public static final BiomeGenBase biomeRakuen = new BiomeRakuen(DqmNextDim.cfgDimBiomeID[DqmNextDim.idxSizen]);
    ...
    public void registerWorldChunkManager()
    {
    	...
    	this.dimensionId = DqmNextDim.cfgDimensionID[DqmNextDim.idxSizen];
    }

    @Override
    public String getDimensionName()
    {
        return "RakuenOfSizen";
    }
    ...
    {
        return new ChunkProviderRakuenDim(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), DqmNextDim.idxSizen);
