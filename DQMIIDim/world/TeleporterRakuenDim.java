...
import DQMIIDim.genDqm2.DqmGenGateHouse;

import com.google.common.collect.Lists;

public class TeleporterRakuenDim extends Teleporter
{
    ...
    public TeleporterRakuenDim(WorldServer par1WorldServer, int idx, int oldDim, int newDim)
    {
	...
	public void placeInPortal(Entity entity, double posX, double posY, double posZ, float rotationYaw)
	{
		...
		{
			//System.out.println("ファイル名3");
			if(this.newDimID == 0)
			{
				//System.out.println("ファイル名4");
				makePortal(entity);
			}else
			{
				//System.out.println("ファイル名5");
				makePortal2(entity);
			}

			//System.out.println("ファイル名6:" + entity.dimension + ":" + posX + "/" + posY + "/" + posZ);
			placeInExistingPortal(entity, posX, posY, posZ, rotationYaw);
			//System.out.println("ファイル名6:" + entity.dimension);
    ...
    */
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == BlockList.DqmDimGateBlockID[dimIdx])
                        {
                            //while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == BlockList.DqmDimGateBlockID[DqmNextDim.idxAkuma])
                            //{
                            //    --i2;
                            //}
        ...
        if (d3 >= 0.0D)
        {
            ...
            par1Entity.setLocationAndAngles(d8 + 2, d9 + 2, d4, par1Entity.rotationYaw, par1Entity.rotationPitch);
