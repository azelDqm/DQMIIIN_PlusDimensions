...
public class WorldProviderRakuenDim6 extends WorldProvider
{

	public static final BiomeGenBase biomeRakuen = new BiomeRakuen(DqmNextDim.cfgDimBiomeID[DqmNextDim.idxTokusyu]);
    ...
    public void registerWorldChunkManager()
    {
    	...
    	this.dimensionId = DqmNextDim.cfgDimensionID[DqmNextDim.idxTokusyu];
    }

    @Override
    public String getDimensionName()
    {
        return "RakuenOfTokusyu";
    }
    ...
    {
        return new ChunkProviderRakuenDim(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), DqmNextDim.idxTokusyu);
