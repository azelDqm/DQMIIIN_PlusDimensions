...
public class WorldProviderRakuenDim0 extends WorldProvider
{

	public static final BiomeGenBase biomeRakuen = new BiomeRakuen(DqmNextDim.cfgDimBiomeID[DqmNextDim.idxAkuma]);
    ...
    {
        return new ChunkProviderRakuenDim(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), DqmNextDim.idxAkuma);
