...
public class WorldProviderRakuenDim3 extends WorldProvider
{

	public static final BiomeGenBase biomeRakuen = new BiomeRakuen(DqmNextDim.cfgDimBiomeID[DqmNextDim.idxMetaru]);
    ...
    public void registerWorldChunkManager()
    {
    	...
    	this.dimensionId = DqmNextDim.cfgDimensionID[DqmNextDim.idxMetaru];
    }

    @Override
    public String getDimensionName()
    {
        return "RakuenOfMetaru";
    }
    ...
    {
        return new ChunkProviderRakuenDim(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), DqmNextDim.idxMetaru);
