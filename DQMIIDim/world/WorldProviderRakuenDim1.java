...
public class WorldProviderRakuenDim1 extends WorldProvider
{

	public static final BiomeGenBase biomeRakuen = new BiomeRakuen(DqmNextDim.cfgDimBiomeID[DqmNextDim.idxBussitu]);
    ...
    public void registerWorldChunkManager()
    {
    	...
    	this.dimensionId = DqmNextDim.cfgDimensionID[DqmNextDim.idxBussitu];
    }

    @Override
    public String getDimensionName()
    {
        return "RakuenOfBussitu";
    }
    ...
    {
        return new ChunkProviderRakuenDim(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), DqmNextDim.idxBussitu);
